...
export class TemplateForInputOnlineBusiness {
  ...
  private static createInputModel (): string {
    return `Crie um Business Canvas detalhado para o meu empreendimento. O empreendimento é de tipo online. A descrição do negócio é a seguinte: {{description}}
Certifique-se de abordar os nove componentes do Business Canvas com ênfase nas particularidades do tipo do negócio. Seja criativo e detalhado criando tópicos específicos para cada componente do Business Canvas. Lembre-se de que, dependendo do contexto do negócio, da complexidade ou de qualquer detalhe adicional que você considere necessário, você pode adicionar até 5 tópicos para cada componente.
Crie também um nome para o Business Canvas utilizando como base o tipo do negócio e sua descrição.
...
{
   “name”: “Nome baseado no tipo do negócio e na sua descrição”, 
  " valueProposition": [
